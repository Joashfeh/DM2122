...
void Camera4::Init(const Vector3& pos, const Vector3& target, const Vector3& up)
{
	...
	this->PositionVector = position - Assignment2::MarioPos;
...
void Camera4::Update(double dt)
{
	...
	position = Assignment2::MarioPos + PositionVector;
	target.Set(Assignment2::MarioPos.x, Assignment2::MarioPos.y + 2.4, Assignment2::MarioPos.z);
